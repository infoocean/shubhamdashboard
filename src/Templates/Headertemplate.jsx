...
import inglogo from "../Assets/Images/HeaderFooterimages/shub.jpeg";
        ...
        <>
            ...
            <nav className="main-header navbar navbar-expand navbar-dark bg-dark">
                ...
                <li className="nav-item dropdown">
                    <a className="nav-link" data-toggle="dropdown" href="#">
                        <i className="far fa-comments"></i><span className="badge badge-danger navbar-badge">3</span>
                    </a>
                    <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" className="dropdown-item">
                        {/*-- Message Start --*/}
                        <div className="media">
                        <img src={inglogo} alt="User Avatar" className="img-size-50 mr-3 img-circle"/>
                    ...
                    <a href="#" className="dropdown-item">
                        {/*-- Message Start --*/}
                        <div className="media">
                        <img src={inglogo} alt="User Avatar" className="img-size-50 img-circle mr-3"/>
                        <div className="media-body">
                            <h3 className="dropdown-item-title">
                            John Pierce
            ...
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" className="brand-link">
                    <img src={inglogo} alt="AdminLTE Logo" className="brand-image img-circle elevation-3"/>
                    <span className="brand-text font-weight-light">Shubham</span>
                </a>
                ...
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div className="image">
                    <img src={inglogo} className="img-circle elevation-2" alt="User Image"/>
                    </div>
                    <div className="info">
                    <a href="#" className="d-block">Shubham</a>
                    </div>
                </div>
                    ...
                    */}
                    <li className="nav-item">
                        <a href="#" className="nav-link">
                            ...
                            <p>Layout Options<i className="fas fa-angle-left right"></i>
